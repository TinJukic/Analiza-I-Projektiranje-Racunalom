...
from PostupciIFunkcije import Euler, ReversedEuler, Trapeze, RungeKutta, PECE2, PECE
...
def zad1() -> None:
    ...
    print(f"\nPE(CE)^2:")
    Loader.save_to(
        file="Matrice/zad1_pece2.txt",
        data=PECE2.calculate(A=A, B=None, x0=x, f_real=Funkcije.f1, T=0.01, t_max=10)
    )
    Drawer.draw_from(file=f"Matrice/zad1_pece2.txt", title=f"PE(CE)^2 - calculated solution", t_max=10, T=0.01)

    print(f"\nPECE:")
    Loader.save_to(
        file="Matrice/zad1_pece.txt",
        data=PECE.calculate(A=A, B=None, x0=x, f_real=Funkcije.f1, T=0.01, t_max=10)
    )
    Drawer.draw_from(file=f"Matrice/zad1_pece.txt", title=f"PECE - calculated solution", t_max=10, T=0.01)
...
def zad2() -> None:
    ...
    print(f"\nPE(CE)^2:")
    Loader.save_to(
        file="Matrice/zad2_pece2.txt",
        data=PECE2.calculate(A=A, B=None, x0=x, f_real=None, T=0.1, t_max=1)
    )
    Drawer.draw_from(file=f"Matrice/zad2_pece2.txt", title=f"PE(CE)^2 - calculated solution", t_max=1, T=0.1)

    print(f"\nPECE:")
    Loader.save_to(
        file="Matrice/zad2_pece.txt",
        data=PECE.calculate(A=A, B=None, x0=x, f_real=None, T=0.1, t_max=1)
    )
    Drawer.draw_from(file=f"Matrice/zad2_pece.txt", title=f"PECE - calculated solution", t_max=1, T=0.1)
...
def zad3() -> None:
    ...
    Loader.save_to(
        ...
        data=Euler.calculate(A=A, B=B, x0=x, f_real=None, T=0.01, t_max=10, r=r)
    )
    ...
    Loader.save_to(
        ...
        data=ReversedEuler.calculate(A=A, B=B, x0=x, f_real=None, T=0.01, t_max=10, r=r)
    )
    Drawer.draw_from(
    ...
    Loader.save_to(
        ...
        data=Trapeze.calculate(A=A, B=B, x0=x, f_real=None, T=0.01, t_max=10, r=r)
    )
    ...
    Loader.save_to(
        ...
        data=RungeKutta.calculate(A=A, B=B, x0=x, f_real=None, T=0.01, t_max=10, r=r)
    )
    Drawer.draw_from(file=f"Matrice/zad3_runge_kutta.txt", title=f"Runge-Kutta - calculated solution", t_max=10, T=0.01)

    print(f"\nPE(CE)^2:")
    Loader.save_to(
        file="Matrice/zad3_pece2.txt",
        data=PECE2.calculate(A=A, B=B, x0=x, f_real=None, T=0.01, t_max=10, r=r)
    )
    Drawer.draw_from(file=f"Matrice/zad3_pece2.txt", title=f"PE(CE)^2 - calculated solution", t_max=10, T=0.01)

    print(f"\nPECE:")
    Loader.save_to(
        file="Matrice/zad3_pece.txt",
        data=PECE.calculate(A=A, B=B, x0=x, f_real=None, T=0.01, t_max=10, r=r)
    )
    Drawer.draw_from(file=f"Matrice/zad3_pece.txt", title=f"PECE - calculated solution", t_max=10, T=0.01)
...
def zad4() -> None:
    ...
    Loader.save_to(
        ...
        data=Euler.calculate(A=A, B=B, x0=x, f_real=None, T=0.1, t_max=1, r=r, update_r=True)
    )
    ...
    Loader.save_to(
        ...
        data=ReversedEuler.calculate(A=A, B=B, x0=x, f_real=None, T=0.1, t_max=1, r=r, update_r=True)
    )
    ...
    Loader.save_to(
        ...
        data=Trapeze.calculate(A=A, B=B, x0=x, f_real=None, T=0.1, t_max=1, r=r, update_r=True)
    )
    ...
    Loader.save_to(
        ...
        data=RungeKutta.calculate(A=A, B=B, x0=x, f_real=None, T=0.1, t_max=1, r=r, update_r=True)
    )
    Drawer.draw_from(file=f"Matrice/zad4_runge_kutta.txt", title=f"Runge-Kutta - calculated solution", t_max=1, T=0.1)

    print(f"\nPE(CE)^2:")
    Loader.save_to(
        file="Matrice/zad4_pece2.txt",
        data=PECE2.calculate(A=A, B=B, x0=x, f_real=None, T=0.1, t_max=1, r=r, update_r=True)
    )
    Drawer.draw_from(file=f"Matrice/zad4_pece2.txt", title=f"PE(CE)^2 - calculated solution", t_max=1, T=0.1)

    print(f"\nPECE:")
    Loader.save_to(
        file="Matrice/zad4_pece.txt",
        data=PECE.calculate(A=A, B=B, x0=x, f_real=None, T=0.1, t_max=1, r=r, update_r=True)
    )
    Drawer.draw_from(file=f"Matrice/zad4_pece.txt", title=f"PECE - calculated solution", t_max=1, T=0.1)
